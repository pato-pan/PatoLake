...
videolite='--cookies cookies.txt --geo-bypass --embed-metadata --embed-thumbnail --embed-chapters --sub-langs all,-live_chat,-rechat -f "[height<=480]" -c' # I prefer 360p as lowest, but some videos may not offer 360p, so I go for 480p to play it safe
